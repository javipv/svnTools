" Script Name: svnTools/utils.vim
 "Description: 
"
...
" Arg3: path2, string to replace the found pattern.
 "Cmd:  Vdf and Vdfv
func! svnTools#utils#DiffSameFileOnPath(...)
    if a:0 == 2
    ...
    redraw
    echo "[SvnTools.vim] Vimdiff: ".l:filepath1." and ".l:filepath2
...
" Cmd:  Vdd1.
func! svnTools#utils#VimdiffAll(...)
    if a:0 < 1
        call svnTools#tools#Error("Arguments error. Missing paths. Arguments: [PATH1] PATH2 [FLAGS]")
        return
    endif
    ...
    if l:path1 == l:path2
        call svnTools#tools#Error("Paths must be different ".l:path1." ".l:path2)
        return
    endif
    ...
    echo " "
    echo " "
    echo "[svnTools.vim] Compare files on: ".l:path1." and ".l:path2." Differing files:".l:n
endfunc
