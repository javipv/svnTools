...
" Used by: SvnD, SvnDA, SvnDD, SvnVD, SvnVDA, SvnVDD, Svndc, Svnvdc, Vdd.
function! svnTools#misc#FilterFilesListWithArgsList(argsList, filesList, path1, path2)
    "echom "svnTools#misc#FilterFilesListWithArgsList("a:argsList.", "a:filesList.", ".a:path1.", ".a:path2.")"
    ...
    return svnTools#misc#FilterFilesListWithOptions(a:filesList, l:equals, l:binaries, l:keepStr, l:filterStr, a:path1, a:path2)
endfunction
...
" Return: filtered files' list.
" Used by: SvnD, SvnDA, SvnDD, SvnVD, SvnVDA, SvnVDD, Svndc, Svnvdc, Vdd.
function! svnTools#misc#FilterFilesListWithOptions(filesList, equals, binaries, keepStr, filterStr, path1, path2)
    "----------------------------------------
    " Check all files:
    "----------------------------------------
    let l:filesList = []
    ...
    if a:equals != "" && !executable('diff')
        call svnTools#tools#Warn("Warning. diff executable not found. Can't check if files differ!")
    endif
